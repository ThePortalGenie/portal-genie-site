...
function ClientPortalDemoInner() {
  return (
    <div className="flex min-h-[100dvh] flex-col bg-white">
      ...
      <div className="grid min-h-[calc(100dvh-28px)] flex-1 lg:grid-cols-[minmax(200px,220px)_minmax(0,1fr)] lg:grid-rows-[auto_1fr]">
        <DemoSidebar />
        <DemoSidebar mobile />
        ...
        <div className="grid min-h-0 min-w-0 lg:col-start-2 lg:row-start-2 lg:grid-cols-[minmax(0,1fr)_minmax(0,1fr)]">
