...
export function CustomisePortalPanel() {
  ...
  return (
    <>
      ...
      >
        <div className="shrink-0 border-b border-muted/20 px-4 py-4">
        ...
        <div className="portal-customise-scroll min-h-0 flex-1 overflow-y-auto overflow-x-hidden px-4 py-4">
