...
export function PricingTrustBar() {
  ...
  return (
    <aside
      className="rounded-card border border-muted/20 bg-surface px-5 py-5 shadow-[0_4px_16px_-8px_rgba(17,33,54,0.08)] md:px-6 md:py-5 lg:py-5"
        ...
        {commonThemes.items.map((item) => (
          <li key={item.title} className="flex items-start gap-2.5">
            ...
            <div className="min-w-0">
              ...
              <p className="mt-1 text-xs leading-snug text-portal-navy/65 sm:text-[13px] sm:leading-snug">
                {item.description}
              </p>
            </div>
          </li>
