  ...
  return (
    <div className="flex justify-center lg:justify-start">
      <div
        ...
        className="inline-flex flex-wrap justify-center gap-1 rounded-button border border-muted/25 bg-surface p-1 shadow-[0_2px_8px_-4px_rgba(17,33,54,0.08)]"
      >
        {pricingCurrencies.map((currency) => {
          ...
          return (
            <button
              ...
              className={[
                "min-w-[3.25rem] rounded-[0.6rem] px-3.5 py-2 text-sm font-medium transition-colors duration-200",
                isActive
